...
<html >
    <head>
        <meta charset="UTF-8">
        <title>Verify Email | {{ getenv('APP_NAME') }}</title>
    </head>
    <body>
        <head>
            <title></title>
        ...
        <body style="background: #F9F9F9;">
            <div style="background-color:#F9F9F9;">
                                                                        ...
                                                                        <tr>
                                                                            <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                                                                <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="width:138px;"><a href="http://lenamobilesbilling.com/" target="_blank"><!--<img alt="" title="" height="38px" src="https://cdn.discordapp.com/email_assets/2ec94ed90b8e95d764f2a1c96f33139e.png" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:38px;" width="138">-->{{ getenv('APP_NAME') }}</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                ...
                </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;" align="center" valign="middle" bgcolor="#7289DA"><a href="{{ session('verifymsg')}}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
                Verify Email
