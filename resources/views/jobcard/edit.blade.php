@include('common.header')
    ...
    <title>Job Card | {{ getenv('APP_NAME') }}</title>
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    @include('alerts.message')
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">                             
                                <form class="needs-validation" novalidate action="{{ route('jobcardEdit', ['id' => $jobcard->id]) }}" method="post" enctype="mutlitpart/form-data" id="jobcardForm">
                                @csrf
                                    <div class="form-row">
                                        <div class="col-md-3 mb-4">
                                            <label for="purchase_order_id">Purchase Order</label>
                                            <select class="placeholder js-states form-control select" name="purchase_order_id" id="purchase_order_id" required disabled>
                                                <option value="" selected disabled>Choose Purchase order...</option>
                                                @foreach($customers as $customer)
                                                <option value="{{ $purchaseorder->id }}" {{ $jobcard->purchase_order_id == $purchaseorder->id?'selected':'' }}>{{ ucfirst(trans($purchaseorder->id)) }}</option>
                                                @endforeach
                                            </select>
                                        </div>

                                        <div class="col-md-3 mb-4">
                                            <label for="poitems">PO Item</label>
                                            <select class="placeholder js-states form-control select" name="poitems" id="poitems" disabled>
                                                <option value="{{ $jobcard->length_mm }}x{{ $jobcard->breadth_mm }}x{{ $jobcard->height_mm }}" selected>{{ $jobcard->length_mm }}x{{ $jobcard->breadth_mm }}x{{ $jobcard->height_mm }}</option>
                                            </select>
                                        </div>

                                        <div class="col-md-3 mb-4">
                                            <label for="quantity">Quantity <span id="quan"></span></label>
                                            <input id="quantity" value="{{ $jobcard->quantity }}" class="form-control" type="number" name="quantity" placeholder="ex: 1000" min=0 required>
                                        </div>

                                        <!-- Dimensions input in mm-->
                                        <div class="col-md-3 mb-4">
                                            <label for="length_mm">Length (in mm)</label>
                                            <input id="length_mm" value="{{ $jobcard->length_mm }}" data-type="length_mm" class="form-control dimensions" type="number" name="length_mm" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="breadth_mm">Breadth (in mm)</label>
                                            <input id="breadth_mm" value="{{ $jobcard->breadth_mm }}" data-type="breadth_mm" class="form-control dimensions" type="number" name="breadth_mm" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="height_mm">Height (in mm)</label>
                                            <input id="height_mm" value="{{ $jobcard->height_mm }}" data-type="height_mm" class="form-control dimensions" type="number" name="height_mm" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <!-- Calculated Dimensions input in Inches-->
                                        <div class="col-md-3 mb-4">
                                            <label for="length_in">Length (in Inches)</label>
                                            <input id="length_in" value="{{ $jobcard->length_in }}" class="form-control" type="number" name="length_in" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="breadth_in">Breadth (in Inches)</label>
                                            <input id="breadth_in" value="{{ $jobcard->breadth_in }}" class="form-control" type="number" name="breadth_in" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="height_in">Height (in Inches)</label>
                                            <input id="height_in" value="{{ $jobcard->height_in }}" class="form-control" type="number" name="height_in" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <!-- Other calculations-->
                                        <div class="col-md-3 mb-4">
                                            <label for="req_reel_size">Required Reel Size (in Inches)</label>
                                            <input id="req_reel_size" value="{{ $jobcard->req_reel_size }}" class="form-control" type="number" name="req_reel_size" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="cutting_length_one_side">Cutting Length One Side</label>
                                            <input id="cutting_length_one_side" value="{{ $jobcard->cutting_length_one_side }}" class="form-control" type="number" name="cutting_length_one_side" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="cutting_length_two_side">Cutting Length Two Side</label>
                                            <input id="cutting_length_two_side" value="{{ $jobcard->cutting_length_two_side }}" class="form-control" type="number" name="cutting_length_two_side" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="area_sq_inches">Area (in Sq Inches)</label>
                                            <input id="area_sq_inches" value="{{ $jobcard->area_sq_inches }}" class="form-control" type="number" name="area_sq_inches" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            <label for="area_sq_meters">Area (in Sq Meters)</label>
                                            <input id="area_sq_meters" value="{{ $jobcard->area_sq_meters }}" class="form-control changesNo" type="number" name="area_sq_meters" placeholder="ex: 1000" min=0 readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive mt-4">
											<table class="table table-stripped table-center" id="plyTable">
												...
												<tbody>
                                                    @foreach($jobcard_ply as $jobcard_ply)
													<tr>
                                                        <td><input class="case" type="checkbox"/></td>
                                                        <td>
                                                            <input type="text" name="ply_no[]" id="plyno_{{ $loop->iteration }}" class="form-control" autocomplete="off" value="{{ $jobcard_ply->ply_no }}" required readonly>
														</td>
														<td>
                                                            <input type="text" name="paper_rate[]" id="paperRate_{{ $loop->iteration }}" class="form-control changesNo" autocomplete="off" value="{{ $jobcard_ply->paper_rate }}" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="paper_bf[]" id="paperBf_{{ $loop->iteration }}" class="form-control changesNo" value="{{ $jobcard_ply->paper_bf }}" autocomplete="off" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="gsm_of_paper[]" id="gsmofPaper_{{ $loop->iteration }}" class="form-control changesNo" value="{{ $jobcard_ply->gsm_of_paper }}" required autocomplete="off" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="gsm[]" id="gsm_{{ $loop->iteration }}" class="form-control" value="{{ $jobcard_ply->gsm }}" required readonly>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="gsm_calculation[]" id="gsmCalculation_{{ $loop->iteration }}" value="{{ $jobcard_ply->gsm_calculation }}" class="form-control gsmCalculation" required readonly>
                                                        </td>   
                                                        <td>
                                                            <input type="text" name="paper_cost[]" id="paperCost_{{ $loop->iteration }}" class="form-control paperCost" value="{{ $jobcard_ply->paper_cost }}" autocomplete="off" required readonly>
                                                        </td>
													</tr>
                                                    @endforeach
												</tbody>
                                            ...
                                            <div class="col-sm-7 col-12 order-sm-1 order-0">
                                                <div class="inv--total-amounts">
                                                    <div class="form-group row  mb-4">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm" id="box_weight" placeholder="0.00" name="box_weight" value="{{ $jobcard->box_weight }}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="" class="col-sm-8 col-form-label col-form-label-sm text-sm-right">Total Paper Cost</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm" id="total_paper_cost" placeholder="ex: 18" name="total_paper_cost" value="{{ $jobcard->total_paper_cost }}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="" class="col-sm-8 col-form-label col-form-label-sm text-sm-right">Conversion Cost</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm" id="conversion_cost" placeholder="ex: 18" name="conversion_cost" value="{{ $jobcard->conversion_cost }}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="" class="col-sm-8 col-form-label col-form-label-sm text-sm-right">Overall Cost</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm" id="overall_cost" placeholder="ex: 18" name="overall_cost" value="{{ $jobcard->overall_cost }}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="" class="col-sm-8 col-form-label col-form-label-sm text-sm-right">Printing Cost</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm pcChange" id="printing_cost" placeholder="ex: 18" name="printing_cost" value="{{ $jobcard->printing_cost }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="" class="col-sm-8 col-form-label col-form-label-sm text-sm-right">Total</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm" id="total" placeholder="ex: 18" name="total" value="{{ $jobcard->total }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        var f1 = flatpickr(document.getElementById('customer_po_date'));
    </script>
